...
## Concepts Learned
In Linux, . means current directory, .. means parent directory, and ~ means your home directory no matter where you are.


## Hands On Work
I started by running the same commands I have learned last week. pwd, ls, ls -la, and touch.
...
- Understanding why . is used when searching using the find command.
- 
